...
#+begin_src emacs-lisp
  (use-package engine-mode
	...
	(defengine google-images "https://www.google.com/search?tbm=isch&q=%s" :docstring "Search Google Images")
	(defengine google-maps "http://maps.google.com/maps?q=%s" :docstring "Search Google Maps.")

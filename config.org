...
** Initialize =vertico=
*** Description
Vertico & friends (Orderless, Marginalia, Consult, Embark) provides a performant and minimalistic vertical completion UI based on the default completion system.
*** Code
#+begin_src emacs-lisp
  ;; Enable vertico
  (use-package vertico

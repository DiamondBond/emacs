...
Welcome to my Emacs configuration. This document along with its auxiliary files, folders & dependencies (available [[https://github.com/DiamondBond/emacs/blob/master/docs/dependencies.org][here]]) should entail a modern, feature-rich & complete Emacs operating system.

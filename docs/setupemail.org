...
Please refer to [[https://github.com/DiamondBond/emacs/blob/master/userconfig.org#email][Email]] in userconfig.org to understand what these functions do, you'll have to change the maildir & my-address flags to correspond to your environments setup.

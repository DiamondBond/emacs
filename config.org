...
#+SETUPFILE: resources/stylish_white.theme
...
* Introduction
  ...
  *[EMACS CONFIGURATION]*
  ...
  [[https://github.com/diamondbond/emacs][*Github*]] | [[https://github.com/DiamondBond/emacs/blob/master/config.org][*Source*]]
  #+end_center
...
** Preview
  ...
  The entire config file can be viewed from [[https://neocities.diamondbond.org/emacs.html][here]] in HTML format.

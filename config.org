#+STARTUP: overview
#+TITLE: Opinionated Emacs Distribution
#+AUTHOR: Diamond Bond
...
Opinionated Emacs Distribution

* Introduction
This Emacs distribution is a very featureful and performant configuration for Emacs. 
* Why would I use this?
Currently, the appeal of this Emacs distribution is a balance of features, performance & usability.

Utilizes Emacs defaults when possible and sticks to lightweight alternatives when needed.
* Setup
...
#+begin_src emacs-lisp
  (defun open-in-mousepad ()
	"Opens in mousepad"
	(interactive)
	(call-process-shell-command "gedit" nil 0))
#+end_src
** light-theme
#+begin_src emacs-lisp
  (defun light-theme ()

...
#+end_src
*** Enable so-long-mode globally
#+begin_src emacs-lisp
  (global-so-long-mode) ;; handles long files.
#+end_src
...
#+end_src
*** =config/upgrade=
Upgrades packages using straight-pull-all.
#+begin_src emacs-lisp
  (defalias 'config/upgrade 'straight-pull-all)
#+end_src
*** =config/github=
Launches this Emacs' configuration GitHub page with the default browser.
#+begin_src emacs-lisp
  (defun config/github ()

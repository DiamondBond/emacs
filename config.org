...
#+begin_src emacs-lisp
  ;; Precision pixel scrolling (DEPENDS: Emacs@HEAD (29+))
...
Org-tree-slider and hide-modeline included for presentation support although org-beamer-export-to-pdf is usually the preferred way for presentations.
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
	...
	(setq dashboard-startup-banner "~/.emacs.d/img/gnusstorm-2.gif")

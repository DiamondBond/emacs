...
#+begin_src emacs-lisp
  ...
  (define-key z-map (kbd "1") 'vscode-mode)
  (define-key z-map (kbd "0") 'vscode-kill)
  ...
  (use-package minimap
	...
	(custom-set-faces
	 '(minimap-active-region-background
	   ((((background dark)) (:background "#545454545454"))
		(t (:background "#cececececece")))
	   "Face for the active region in the minimap.
  By default, this is only a different background color."
	   :group 'minimap)))
  ;; automatically open minimap when editing jsx/tsx
  ;; :hook (web-mode . minimap-mode))
#+end_src
*** Initialize =mlscroll=
**** Description
Modeline scrollbar.
...
#+begin_src emacs-lisp
  ...
  ;; automatically enable IDE mode when opening react files
  ;; (add-hook 'web-mode-hook #'(lambda () (vscode-mode)))
#+end_src
** Config
*** =config/tangle=
...
Applies Iosevka fonts.
#+begin_src emacs-lisp
  (defun config/iosevka-fonts ()
	"Applies Iosevka fonts."
	(interactive)

...
#+AUTHOR: Diamond Bond
#+DESCRIPTION: Eight Megabytes And Constantly Swapping Configuration
#+LANGUAGE: en
#+OPTIONS: num:nil
...
** C & C++
*** Description
Lsp-mode is the backend for C and C++
*** Code
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
	:init
...
** Python
*** Description
Elpy for basics & Jedi for better autocomplete and static code analysis. Autopep8 automatically applies proper python coding standards on save, if not already.
*** Code
#+BEGIN_SRC emacs-lisp
  ;; Set python3
...
** JavaScript
*** Description
Self-contained, lightweight and minimalist major-mode focused on providing basic font-lock/syntax-highlighting and indentation for Javascript syntax, without any external dependencies.
*** Code
#+begin_src emacs-lisp

...
Some dependencies are required to run this Emacs configuration smoothly.
...
** Globals
*** Description
Global variables to easily customize Emacs.
Override this in =userconfig.org=.
*** Code
#+begin_src emacs-lisp
  (setq
		...
		(lambda nil
		  (concat
		   (if (string= (eshell/pwd) (getenv "HOME"))
			   (propertize "~" 'face `(:foreground "#00538b"))
			 (replace-regexp-in-string
			  (getenv "HOME")
			  (propertize "~" 'face `(:foreground "#00538b"))
			  (propertize (eshell/pwd) 'face `(:foreground "#00538b"))))
		   (if (= (user-uid) 0)
			   (propertize " α " 'face `(:foreground "#780000"))
...
#+begin_src emacs-lisp
  (use-package yasnippet
	...
	:hook
	((cc-mode c-lang-common cmake-mode c++-mode c-mode conf-unix-mode csharp-mode css-mode emacs-lisp-mode fundamental-mode git-commit-mode go-mode js-mode js2-mode html-mode makefile-mode makefile-automake-mode markdown-mode org-mode prog-mode python-mode rjsx-mode rust-mode text-mode typescript-mode web-mode) . yas-minor-mode)
	:config
	(yas-reload-all))
...
#+begin_src emacs-lisp
  (use-package engine-mode
	...
	(defengine google-images "https://www.google.com/search?tbm=isch&q=%s" :keybinding "i" :docstring "Search Google Images")
	(defengine google-maps "http://maps.google.com/maps?q=%s" :keybinding "m" :docstring "Search Google Maps.")

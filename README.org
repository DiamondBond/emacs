...
It is recommend to run this distribution with the latest [[https://ftp.gnu.org/gnu/emacs/emacs-28.1.tar.xz][Emacs 28.1 Release]] compiled from source with these [[https://github.com/DiamondBond/emacs/blob/master/README.org#configuration][configure flags]].

[[https://github.com/DiamondBond/emacs/blob/master/config.org][Main Configuration]]

[[https://github.com/DiamondBond/emacs/blob/master/config.org#use-package][Package Declarations]]

[[https://github.com/DiamondBond/emacs/blob/master/config.org#keybinds][Keybind Maps]]

[[https://github.com/DiamondBond/emacs/blob/master/config.org#functions][Functions Definitions]]
...
#+end_src
** Files
Certain files & folders must exist for some hooks/functions within Emacs to work.

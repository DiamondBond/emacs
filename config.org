...
Welcome to my Emacs configuration, this file is an ongoing accumulation of [[https://github.com/DiamondBond/emacs/blob/master/img/lines-of-emacsd.png][2+ years]] of [[https://projects.csail.mit.edu/gsb/old-archive/gsb-archive/gsb2000-02-11.html][yak shaving]].
...
- Fully featured writing capabilities; live preview, spellcheck, dictionary & thesaurus lookup, flesch-kincaid reports, quick engine search, common academic phrases helper and etc...
...
Please feel free to import snippets from my configuration into your own configuration if you want or consider forking this repo & maintaining it with your own customizations or send them my way via a pull request.

If you would like to use this configuration whilst pulling from upstream every once in a while then consider placing all your customizations in =userconfig.org=.
...
*** Initialize =midnight=
**** Description
Clean buffer list at set time.
**** Code
#+begin_src emacs-lisp
  (use-package midnight
	:straight t
	:config
	(midnight-delay-set 'midnight-delay 3600) ;; 1am)
#+end_src
*** Initialize =flycheck=
**** Description

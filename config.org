...
#+end_src
*** Load userconfig.el
Whenever the base =config.org= file is updated, all the custom user settings are wiped out.

To prevent this, the user may define permanent settings in the =userconfig.org= file.
#+begin_src emacs-lisp
...
*** Description
Meta shift & Mouse-1 to drag-stuff.
*** Code
#+begin_src emacs-lisp

...
Please refer to the [[https://github.com/DiamondBond/emacs/blob/master/modules/mail.org][Email]] module to understand what these functions do, you'll have to change the maildir & my-address flags to correspond to your own maildir & address.

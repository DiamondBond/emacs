;;; lensor-min-theme.el --- A minimalist dark theme -*- lexical-binding:t -*-
...
;; then load from `~/.emacs` init file with (load-theme 'lensor-min).

;; (copy-file "lensor-min-theme.el" "~/.emacs.d/lensor-min-theme.el" t)
...
(let ((*foreground* "#ffffff")
      ...
      (*lensor-green*           "#2da50e")
      (*lensor-min-green*       "#68c94f")
      (*lensor-light-green*     "#0aff8d")
      (*lensor-min-light-green* "#afd787")
  ...
  (custom-theme-set-faces
   ...
   ;;; Font lock
   `(font-lock-builtin-face       ((t (:foreground , *lensor-min-magenta*))))
   ...
   `(font-lock-keyword-face       ((t (:foreground , *lensor-min-magenta*))))
   `(font-lock-string-face        ((t (:foreground , *lensor-min-green*))))
   ...
   `(font-lock-delimiter-face     ((t (:foreground , *lensor-min-light-green*))))
...
(provide-theme 'lensor-min)

;;; lensor-min-theme.el ends here

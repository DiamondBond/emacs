...
#+begin_src emacs-lisp
  (use-package yasnippet
	...
	:hook
	((cmake-mode c-mode c++-mode conf-unix-mode csharp-mode css-mode go-mode js-mode js2-mode html-mode makefile-mode makefile-automake-mode markdown-mode org-mode python-mode rjsx-mode rust-mode text-mode typescript-mode web-mode) . yas-minor-mode)
	:config
	(yas-reload-all))

...
#+begin_src emacs-lisp
  ...
  (setq
   ...
   globals--font         "Ubuntu Mono 18"                     ; Font
...
#+begin_src emacs-lisp
  ...
  (define-key z-map (kbd "C-1") 'consult-buffer-other-frame)
...
*** Initialize =elmacro=
**** Description
Convert keyboard macros or latest interactive commands as emacs lisp.
**** Code
#+begin_src emacs-lisp
  (use-package elmacro
	:disabled t
...
**** Description
Allows you to edit text areas of the browser via Emacs.
**** Code
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package chatgpt
	...
	(setq chatgpt-query-format-string-map '(
											...
											("understand" . "What does the following code do?\n\n%s")
											("improve" . "Please improve the following code.\n\n%s")
											;; Misc
											("nil" . "%s")
											("define" . "Please define the following.\n\n%s")
											("explain" . "Please explain the following.\n\n%s")
											("eli5" . "Explain like I am 5.\n\n%s")
											("table" . "Explain in tabular form.\n\n%s")
											)))
#+end_src
** Git
*** Initialize =magit=
...
** C/C++
*** Description
Modern C++ syntax highlighting & astyle formatter.
*** Code
#+begin_src emacs-lisp
...
#+end_src
*** =config/setup-fonts=
Applies desired fonts.
#+begin_src emacs-lisp
  (defun config/setup-fonts ()
	"Configure fonts."
	(interactive)
	(set-face-attribute 'default nil :font (font-spec :family "Iosevka Comfy" :size 12.0 :dpi 144 :weight 'regular))
	(set-face-attribute 'fixed-pitch nil :font (font-spec :family "Iosevka Comfy" :size 12.0 :dpi 144 :weight 'regular))
	(set-face-attribute 'variable-pitch nil :font (font-spec :family "DejaVu Sans Mono" :size 12.0 :dpi 144 :weight 'medium))
	(set-fontset-font t 'unicode "DejaVu Sans Mono"))
#+end_src
*** =auth/backup=
Backup auth files.
#+begin_src emacs-lisp

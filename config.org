...
#+begin_src emacs-lisp
  (use-package minimap
	...
	(setq minimap-major-modes '(web-mode))
	;; changing colors
	(custom-set-faces
	 '(minimap-active-region-background
	   ((((background dark)) (:background "#333333333333"))
		(t (:background "#333333333333")))
	   "Face for the active region in the minimap.
	By default, this is only a different background color."
	   :group 'minimap)))
#+end_src
** Tools
*** Initalize =projectile=
**** Description

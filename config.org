...
#+end_src
*** Load custom lisp
Auto-load any custom lisp in =~/.emacs.d/lisp=.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f7>") 'local-scroll-bar-toggle)
...
** Email
*** Description
[[https://github.com/DiamondBond/emacs/blob/master/modules/mail.org][Email module]].
*** Code
#+begin_src emacs-lisp
  ;; Load email module
...
** Jira
*** Description
[[https://github.com/nyyManni/ejira#installation][Jira module]].
*** Code
#+begin_src emacs-lisp
  ;; Load jira module
  (when (file-directory-p

...
#+end_src
** Identity
Set identity and email address.
#+begin_src emacs-lisp
...
Symlink authinfo.
#+begin_src sh
  ln -s ~/org/.authinfo.gpg ~/.authinfo
#+end_src
Set authinfo file location and expiry to never.
#+begin_src emacs-lisp
...
#+end_src
Precision pixel scrolling for Emacs>=29
#+begin_src emacs-lisp
...
I prefer to enable this only in =org-mode=
#+begin_src emacs-lisp
...
*** Description
#+begin_src sh
  yay -S offlineimap mu
  mu init --maildir=/home/diamond/mail/ --my-address=diamondbond1@gmail.com
  mu index
#+end_src
*** Code
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package md4rd :ensure t
	...
	(setq md4rd--oauth-access-token
		  "b54o-0xVeapTlgqkHeMIMWEeYIoLAg")

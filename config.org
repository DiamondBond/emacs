#+STARTUP: overview
#+TITLE: Diamond's Emacs Configuration
#+LANGUAGE: en
#+OPTIONS: num:nil
...
#+end_src
** Files
Certain files must exist for correct operation of this emacs config.
...
~/.emacs.d		# This houses my emacs configuration (this repo)
#+end_quote
** Emacs

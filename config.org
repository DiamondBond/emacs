...
#+begin_src emacs-lisp
  ...
  (define-key z-map (kbd "G") 'org-mark-ring-goto)
  (define-key z-map (kbd "h") (lambda () (interactive) (global-hl-line-mode 0)))
  (define-key z-map (kbd "H") (lambda () (interactive) (global-hl-line-mode 1)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-wild-notifier
	...
	(setq org-wild-notifier-alert-time '(1 5 10 15 30))
...
#+begin_src emacs-lisp
  (defun start-to-org-agenda ()
	"Environment manipulation macro to launch focused org-agenda."
	(interactive)
	(org-agenda-list)

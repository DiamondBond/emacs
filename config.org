...
- [[https://github.com/DiamondBond/emacs/blob/master/early-init.el][early-init]] - Early Emacs initialization

*** *init.el*

- [[https://github.com/DiamondBond/emacs/blob/master/init.el][init]] - Initialize Emacs & straight.el
